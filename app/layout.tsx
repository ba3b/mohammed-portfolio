...
export const metadata: Metadata = {
  ...
  description:
    "Mobile Application Developer building production apps with React Native (Expo) and Flutter. UI-led, performance-first, production-ready.",
  ...
  openGraph: {
    ...
    title: "Mohammed Baabad - Mobile Application Developer",
    description: "Mobile Application Developer building production apps with React Native (Expo) and Flutter.",
